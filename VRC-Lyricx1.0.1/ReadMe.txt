...
Note: You need a spotify application, Click here for how to make one.
Make name/discription anything you like, Set the redirect uri to "http://localhost:7777/callback" without quotation marks
Configuring:

Go to info/config.ini and open it in notepad enter appropriate info:
...
Github: https://github.com/Layria-b/VRC-Lyricx
Version: 1.0.1